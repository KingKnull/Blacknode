    ...
    <div class="relative w-[400px]">
      ...
      <div class="mb-8 flex flex-col items-center gap-4">
        ...
        <div class="text-center">
          <div class="font-mono type-body font-bold tracking-[0.25em] text-[var(--color-accent)]">BLACKNODE</div>
      ...
      <div class="overflow-hidden border hairline-strong surface-2 shadow-2xl"
        ...
        {#if !app.vault.initialized}
          ...
          <div class="border-b hairline px-5 py-3 flex items-center gap-2">
            ...
            <span class="type-eyebrow font-mono type-micro text-[var(--color-text-1)]">Init vault</span>
          </div>
