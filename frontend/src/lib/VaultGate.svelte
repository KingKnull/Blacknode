    ...
    <div class="relative w-[400px]">
      ...
      <div class="mb-8 flex flex-col items-center gap-4">
        ...
        <div class="text-center">
          ...
          <div class="mt-1 type-caption text-[var(--color-text-4)]">Remote ops platform</div>
        </div>
      </div>

      <!-- Card -->
      <div class="overflow-hidden border hairline-strong surface-2 shadow-2xl"
        style="border-radius: var(--radius-md); backdrop-filter: blur(16px) saturate(1.3); box-shadow: 0 0 0 1px var(--color-line-strong), 0 0 60px rgba(0,255,136,0.06), 0 40px 80px rgba(0,0,0,0.6);">
        ...
        {#if !app.vault.initialized}
          ...
          <div class="border-b hairline px-5 py-3 flex items-center gap-2">
            ...
            <span class="font-mono type-micro font-bold uppercase tracking-[0.12em] text-[var(--color-text-1)]">Init vault</span>
          </div>
        ...
        {:else}
          ...
          <div class="border-b hairline px-5 py-3 flex items-center gap-2">
            <Key size="11" class="text-[var(--color-accent)]" />
            <span class="font-mono type-micro font-bold uppercase tracking-[0.12em] text-[var(--color-text-1)]">Unlock vault</span>
          </div>
          <div class="space-y-4 p-5">
            <p class="type-caption text-[var(--color-text-3)] leading-relaxed">
