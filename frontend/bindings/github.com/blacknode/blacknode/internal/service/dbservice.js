 ...
 */
export function Connect(hostID, kind, dsn) {
    return $Call.ByID(3912168352, hostID, kind, dsn).then(/** @type {($result: any) => any} */(($result) => {
 ...
 * @returns {$CancellablePromise<$models.DBConnectionInfo>}
 */
export function ConnectSaved(savedID) {
    return $Call.ByID(4226580571, savedID).then(/** @type {($result: any) => any} */(($result) => {
        return $$createType2($result);
    }));
}
