 ...
 */
export function Connect(sessionID: string, hostID: string): $CancellablePromise<void> {
 ...
 */
export function Ports(): $CancellablePromise<string[]> {
    return $Call.ByID(3891599200).then(($result: any) => {
