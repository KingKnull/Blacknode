 ...
 */
export function DNSLookup(hostID, target, recordType) {
    return $Call.ByID(1960944829, hostID, target, recordType).then(/** @type {($result: any) => any} */(($result) => {
 ...
 */
export function Ping(hostID, target, count) {
    return $Call.ByID(573217668, hostID, target, count).then(/** @type {($result: any) => any} */(($result) => {
 ...
 */
export function PortScan(hostID, target, ports) {
    return $Call.ByID(1777280254, hostID, target, ports).then(/** @type {($result: any) => any} */(($result) => {
 ...
 */
export function SSLCert(hostID, target) {
    return $Call.ByID(1570785132, hostID, target).then(/** @type {($result: any) => any} */(($result) => {
