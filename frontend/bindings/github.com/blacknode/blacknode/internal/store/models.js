...
export class Host {
    ...
    constructor($$source = {}) {
        ...
        if (/** @type {any} */(false)) {
             ...
             * @type {string | undefined}
             */
            this["startupSnippetID"] = undefined;
        }
        if (/** @type {any} */(false)) {
            /**
...
export class KnownHost {
     ...
     * @param {Partial<KnownHost>} [$$source = {}] - The source object to create the KnownHost.
     */
    constructor($$source = {}) {
        if (!("host" in $$source)) {
            /**
    ...
    static createFrom($$source = {}) {
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
        return new KnownHost(/** @type {Partial<KnownHost>} */($$parsedSource));
    }
}
